    ...
    <section className="max-w-7xl mx-auto px-4 py-16 lg:py-24">
      <div className="grid grid-cols-1 md:grid-cols-2 items-start">
        <div className="space-y-4">
            <h2 className="text-4xl text-in-blue-title font-in-nunito font-bold">
            La Esencia de Nuestros Valores
            </h2>
            <p className="text-in-blue-title font-in-poppins text-sm">Incorporamos tecnología de vanguardia para mejores resultados.</p>
            <div>
            <Button
        ...
        <div className="space-y-12">
            <article className="flex items-center gap-12">
                <div className="flex flex-col items-center gap-2">
                    <Image src="/images/nosotros/values/capsule.svg" alt="" width={39} height={39} />
                    <Image src="/images/nosotros/values/line.svg" alt="" width={2} height={78} />
                </div>
                <div className="space-y-2">
                    <h3 className="text-4xl font-in-nunito font-bold">Innovación</h3>
                    <p className="text-in-blue-title font-in-poppins max-w-xs">Incorporamos tecnología de vanguardia para mejores resultados.</p>
                </div>
            </article>
            <article className="flex items-center gap-12">
                <div className="flex flex-col items-center gap-2">
