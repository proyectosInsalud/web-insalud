...
export const ItemServiceInfo = ({
  ...
  const includeButtonMore = [
    "chequeo-prostatico", 
    "ondas-de-choque-prostatitis", 
    "ondas-de-choque-disfuncion", 
    "cauterizacion-laser-vph",
    "vacuna-vph",
  ];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex gap-2">
        ...
        {includeButtonMore.includes(slug ?? "") && (
          <Link className="flex-1" href={"/tratamientos/" + slug}>
            <Button
              className="w-full py-2.5 bg-in-cyan text-base font-in-nunito rounded-2xl hover:bg-in-cyan/80 cursor-pointer"
              size={"personal"}
            >
