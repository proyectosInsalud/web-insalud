...
export const ReserveDate = () => {
  ...
  return (
    <div className="max-w-5xl container mx-auto px-4">
      <section
        className="grid grid-cols-1 md:grid-cols-12 gap-x-8 rounded-4xl py-6 px-8 bg-white -mt-24 md:mt-0"
        style={{ boxShadow: "0 4px 24px rgba(0, 180, 216, 0.20)" }}
      >
        <div className="grid grid-cols-3 col-span-9 gap-x-2">
            {/* Problema de Salud */}
        ...
        <div className="col-span-3">
          <Button
            ...
            size={"personal"}
            className="w-full h-[60px] p-0 text-base cursor-pointer font-in-poppins hover:bg-in-cyan bg-in-cyan/90 rounded-full"
          >
