...
export const CtaServicios = () => {
  return (
    <div className="font-in-poppins flex flex-col gap-4 items-start">
        ...
        <Link href="#servicios" className="bg-in-blue text-sm text-center text-white rounded-full py-3 hover:bg-in-blue/80 transition-colors cursor-pointer px-8">Explora nuestros servicios</Link>
    </div>
  )
}
