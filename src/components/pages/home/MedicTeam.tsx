      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-4 items-center">
        <div>
            <div className="space-y-6">
                <h2 className="font-in-nunito font-bold text-3xl md:text-4xl lg:text-5xl text-in-blue-dark">Un equipo médico de expertos, <span className="text-in-cyan">listos para atenderte.</span> </h2>
